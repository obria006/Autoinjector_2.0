...
class ControlWindow(QMainWindow):
    ...
    def make_pipette_calibrator_widgets(self):
        ...
        self.angle_mode_box.setToolTip("Specify how system acquires manipulator D-axis angle")
        self.angle_entry = QLineEdit(self)
        self.angle_entry.setToolTip("Display (or specify) manipulator D-axis angle")
        self.set_angle_button = QPushButton("Set", self)
        self.set_angle_button.setToolTip("Set manipulator D-axis angle to value in entry box")
        self.save_angle_button = QPushButton("Save Angle", self)
        self.save_angle_button.setToolTip("Save angle value to file")
        self.load_angle_button = QPushButton("Load Angle", self)
        self.load_angle_button.setToolTip("Load most recently saved angle value from file")
        ...
        self.cal_mode_box.setToolTip("Specify how system completes calibration process")
        self.conduct_calibration_but = QPushButton("Conduct Calibration")
        self.conduct_calibration_but.setToolTip("Open calibration window to make a NEW calibration")
        self.update_calibration_but = QPushButton("Update Calibration")
        self.update_calibration_but.setToolTip("Open calibration window to UPDATE EXISTING calibration")
        self.save_calibration_but = QPushButton("Save Calibration", self)
        self.save_calibration_but.setToolTip("Save existing calibration to file")
        self.load_calibration_but = QPushButton("Load Calibration", self)
        self.load_calibration_but.setToolTip("Load most recently saved calibration from file")
        form = QFormLayout()
        ...
        self.cal_mode_display.setToolTip("Current calibration mode")
        cal_type_label = QLabel("Calibration Type:")
        self.cal_type_display = QLabel("")
        self.cal_type_display.setToolTip("Indicates new versus update calibration")
        self.complete_calibration_but = QPushButton("Complete Calibration")
        self.complete_calibration_but.setToolTip("Compute and use calibration for microinjections")
        self.auto_calibrate_but = QPushButton("Run Auto-Calibration")
        self.auto_calibrate_but.setToolTip("Autofocus and autodetect pipette to automatically calibrate")
        self.save_complete_calibration_but = QPushButton("Save and Complete Calibration")
        self.save_complete_calibration_but.setToolTip("Compute and use calibration for microinjections. Also save calibration to file.")
        self.exit_calibration_but = QPushButton("Exit")
        self.exit_calibration_but.setToolTip("Leave calibration process without computing calibration.")
        h_sep2 = QHLine()
    ...
    def make_data_generator_widgets(self):
        ...
        self.save_tip_annot_rbon.setToolTip("Save image and coordinates of pipette to file during calibration")
        rboff1 = QRadioButton("Off")
        rboff1.setToolTip("Don't save image and coordinates of pipette during calibration")
        save_tissue_annot_label = QLabel('Save tissue:')
        self.save_tiss_annot_rbon = QRadioButton("On")
        self.save_tiss_annot_rbon.setToolTip("Save image and coordinates of tissue annotation to file during annotation")
        rboff2 = QRadioButton("Off")
        rboff2.setToolTip("Don't save image and coordinates of tissue annotation to file during annotation")
    ...
    def make_annotation_widgets(self):
        ...
        self.annotation_button.setToolTip("Open annotation window to make new annotations")
        self.rm_annotation_button = QPushButton("Remove All Annotations")
        self.rm_annotation_button.setToolTip("Remove all existing annotations")
        ...
        self.annotation_combo_box.setToolTip("Specify how system draws annotation")
        self.annotation_combo_box.setPlaceholderText('Mode')
        self.complete_annotation_button = QPushButton("Complete Annotation")
        self.complete_annotation_button.setToolTip("Finish annotating and use annotations for microinjection")
        self.exit_annotation_button = QPushButton("Exit Annotation")
        self.exit_annotation_button.setToolTip("Leave annotation window without retaining annotations")
        hline = QHLine()
        ...
        self.edge_type_combo_box.setToolTip("Specify type of edge to auomatically annotate")
        self.single_auto_annotation_button = QPushButton('Run Single Auto. Annotation')
        self.single_auto_annotation_button.setToolTip("Automatically annotate edges in current FOV")
        zstack_label = QLabel('Z-Stack Annotation')
        self.plane1_button = QPushButton('Set first focus')
        self.plane1_button.setToolTip("Set starting focus height for z-stack")
        self.plane2_button = QPushButton('Set last focus')
        self.plane2_button.setToolTip("Set finishing focus height for z-stack")
        palette = QPalette()
        ...
        self.plane1_entry.setToolTip("Starting focus height for z-stack")
        ...
        self.plane2_entry.setToolTip("Finishing focus height for z-stack")
        ...
        self.slices_entry.setToolTip("Specify number of sections in z-stack")
        self.zstack_button = QPushButton('Run Z-Stack Auto. Annotation')
        self.zstack_button.setToolTip("Automatically annotate edges in z-stack FOVs")
        self.zstack_stop_button = QPushButton('Stop Z-Stack')
        self.zstack_stop_button.setToolTip("Immediately stop z-stack process")
        progress_label = QLabel("Z-Stack Progress:")
        self.zstack_progress = QProgressBar()
        self.zstack_progress.setToolTip("Percentage completed of z-stack")
        zstack_status_label = QLabel("Z-Stack Results:")
        self.zstack_status = QLabel('Not Applicable')
        self.zstack_status.setToolTip("Shows number of z-stack sections that were annotated")
    ...
    def make_display_modification_widgets(self):
        ...
        self.exposure_slider.setToolTip("Set camera exposure level")
    ...
    def make_injection_parameter_widgets(self):
        ...
        self.approach_entry.setToolTip("Enter the approach distance for microinjection process")
        ...
        self.approach_display.setToolTip("Displays currently set approach distance")
        self.depth_entry= SmallQLineEdit()
        self.depth_entry.setToolTip("Enter the penetration depth for the microinjection process")
        ...
        self.depth_display.setToolTip("Displays currently set penetration depth")
        self.spacing_entry = SmallQLineEdit()
        self.spacing_entry.setToolTip("Enter spacing between injection locations")
        ...
        self.spacing_display.setToolTip("Displays currently set injection spacing distance")
        self.speed_entry = SmallQLineEdit()
        self.speed_entry.setToolTip("Enter manipulator movement speed")
        ...
        self.speed_display.setToolTip("Displays currently set manipulator speed")
        self.set_values_button = QPushButton("Set Values")
        self.set_values_button.setToolTip("Set microinjection parameters according to values in above boxes")
        ...
        self.track_annot_rbon.setToolTip("Track tissue movement and compensate annotation position during microinjections")
        self.track_annot_rboff = QRadioButton("Off")
        self.track_annot_rboff.setToolTip("DON'T track tissue movement and compensate annotation position during microinjections")
        bg1 = QButtonGroup(self)
    ...
    def make_manipulator_control_widgets(self):
        ...
        self.unload_button.setToolTip("Move manipulator to 'unload' position")
        # self.displace_button = QPushButton("Go to 'right'")
        self.undo_button = QPushButton("Undo previous")
        self.undo_button.setToolTip("Reverse the most recent 'unload' or 'undo' movement")
        ...
        layout.addWidget(self.undo_button,1,0,1,1)
    ...
    def make_workflow_widgets(self):
        ...
        angle.setToolTip("Completion status of setting angle")
        self.angle_indicator = QLabel()
        self.angle_indicator.setToolTip("Completion status of setting angle")
        calibration = QLabel('Conduct manipulator calibration')
        calibration.setToolTip("Completion status of calibration process")
        self.calibration_indicator = QLabel()
        self.calibration_indicator.setToolTip("Completion status of calibration process")
        annotation = QLabel('Annotate injection target')
        annotation.setToolTip("Completion status of annotation process")
        self.annotation_indicator = QLabel()
        self.annotation_indicator.setToolTip("Completion status of annotation process")
        parameter = QLabel('Set injection parameters')
        self.parameter_indicator = QLabel()
        self.parameter_indicator.setToolTip("Completion status of setting microinjection parameters")
        hline = QHLine()
        self.run_button = QPushButton("Run Trajectory")
        self.run_button.setToolTip("Start the microinjection process")
        self.stop_button = QPushButton("Stop Process")
        self.stop_button.setToolTip("Immediately stop microinjection process")
        layout = QVBoxLayout()
        form = QFormLayout()
    ...
    def make_system_status_widgets(self):
        ...
        self.fps_label.setToolTip("Estimated frames-per-second of video display")
